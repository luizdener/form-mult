  ...
  return (
    <div className='review-form'>
      <div className="form-control score-container">
        ...
        <label className='radio-container'>
          <input type="radio" value='love' name='review' required checked={data.review === 'love'} onChange={(e) => updateFieldHandler("review", e.target.value)}/>
      ...
      <div className="form-control">
        ...
        <textarea name="coment" id="comment" placeholder='Conte-nos a sua experiência com o produto' required onChange={(e) => updateFieldHandler("comment", e.target.value)}></textarea>
      </div>
    </div>
  )
}
